...
def get_similarity(prefs, person1, person2):
...
def sim_distance(prefs, person1, person2):
    si = get_similarity(prefs, person1, person2)
...
def getRecommendations(prefs,person,similarity=sim_pearson):
    ...
    for other in prefs:
        ...
        for item in prefs[other]:
            ...
            if item not in prefs[person] or 0 == prefs[person][item]:
                # Similarity * Score
